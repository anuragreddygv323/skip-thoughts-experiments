...
def model_config(
    ...
    Args:
        input_file_pattern: File pattern of sharded TFRecord files containing tf.Example protobufs.
        input_queue_capacity: Number of examples to keep in the input queue.
        num_input_reader_threads: Number of threads for prefetching input tf.Examples.
        ...
        bidirectional_encoder: Whether to use a bidirectional or unidirectional encoder RNN.
...
def training_config(
    ...
    Args:
        ...
        learning_rate_decay_steps: The number of steps before the learning rate decays by learning_rate_decay_factor.
        number_of_steps: The total number of training steps to run. Passing None will cause the training script to run indefinitely.
    ...
    Raises:
        ValueError: If learning_rate_decay_factor is set and learning_rate_decay_steps is unset.
    """
